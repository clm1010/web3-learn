...
// infura api
const INFURA_MAINNET_URL = `https://mainnet.infura.io/v3/${process.env.INFURA_KEY}`;
const INFURA_SEPOLIA_URL = `https://sepolia.infura.io/v3/${process.env.INFURA_KEY}`;
...
const main = async () => {
  ...
  const decimalsWETH = await contractWETH.decimals()
  console.log("\n1. 读取WETH合约信息")
  console.log(`合约地址: ${addressWETH}`)
  console.log(`名称: ${nameWETH}`)
  console.log(`代号: ${symbolWETH}`)
  console.log(`Decimals: ${decimalsWETH}`)
