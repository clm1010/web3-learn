...
OpenZeppelin 是应用智能合同的行业中最受欢迎的库源，而且是开源的。 使用 OpenZeppelin 合同时，你将了解开发智能合同的最佳做法。 合同类型多种多样，包括：
...
让我们复用上⼀章节创建 Hardhat 项⽬，然后加入 OpenZeppelin 合约库。如果还没创建 Hardhat 项目,请参照上⼀章节
...
- 当前安装的版本是 5.0.2，在 package.json 中可以看到
  请注意，发生了几件事：
